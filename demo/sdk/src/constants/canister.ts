/**
 * SIWB Canister Configuration
 * These values are hardcoded as they don't change per environment
 */
...
// SIWB provider key for the SDK
export const SIWB_PROVIDER_KEY = 'odin-sdk';
